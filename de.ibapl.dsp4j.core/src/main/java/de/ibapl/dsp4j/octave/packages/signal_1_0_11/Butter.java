 ...
 *
 * [b,a] = butter(n, [Wl, Wh]) band pass filter with edges pi*Wl and pi*Wh
 * radians
 *
 * [b,a] = butter(n, [Wl, Wh], 'stop') band reject filter with edges pi*Wl and
 * pi*Wh radians
 *
 * [z,p,g] = butter(...) return filter as zero-pole-gain rather than
 * coefficients of the numerator and denominator polynomials.
 *
 * [...] = butter(...,'s') return a Laplace space filter, W can be larger than
 * 1.
 *
