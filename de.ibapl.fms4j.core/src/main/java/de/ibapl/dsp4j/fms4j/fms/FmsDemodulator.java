...
public class FmsDemodulator {
    ...
    private final static Logger LOG = Logger.getLogger(FmsDemodulator.class.getCanonicalName());
        ...
        switch (state) {
            case DIENSTKENNUNG:
                ...
                if (bitStack.isFull()) {
                    try {
                        ...
                        if (fail) {
                            LOG.log(Level.INFO, "Failed: " + fmsData, ex);
                            reset();
            ...
            case TXT_LENGTH:
                ...
                if (bitStack.isFull()) {
                    try {
                        ...
                        if (fail) {
                            LOG.log(Level.INFO, "Faied: " + fmsData, ex);
                            reset();
            ...
            case TXT_SCHLUSSBIT:
                ...
                if (lastTxtBlock) {
                    ...
                    LOG.log(Level.INFO, "fms msg " + fmsData);
                    final FmsData data = fmsData;
                    reset();
                    return data;
                } else {
    ...
    private void setState(DecodeState decodeState) {
        if (LOG.isLoggable(Level.FINEST)) {
            LOG.finest("new state: " + decodeState);
        }
        state = decodeState;
    }
