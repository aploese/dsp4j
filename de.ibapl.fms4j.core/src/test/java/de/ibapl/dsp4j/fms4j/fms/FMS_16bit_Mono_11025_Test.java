...
public class FMS_16bit_Mono_11025_Test {
	...
	public void testFmsAudio_00_46_31_095() throws Exception {
		...
		testSetup.add(FILTER_DELAY + 117000,
				new FmsData(FW, BW, "64", "07-99", (byte) 0x03, BEIDE_RICHTUNGEN, LST_ZU_FZG, TKI_IV));
		testSetup.add(FILTER_DELAY + 123000,
				new FmsData(FW, BW, "64", "07-99", (byte) 0x03, BEIDE_RICHTUNGEN, LST_ZU_FZG, TKI_IV));
		testSetup.add(Integer.MAX_VALUE, FmsData.TXT_LENGTH_PARITY_ERROR_DUMMY);
		testSetup.add(FILTER_DELAY + 131992, new FmsData(FW, BW, "64", "07-99", NUR_VOM_FZG, LST_ZU_FZG, TKI_III,
				"Unwetter Wassernot  \n\nIm Untertal 21      \nYach"));
		testSetup.add(Integer.MAX_VALUE, FmsData.TXT_LENGTH_PARITY_ERROR_DUMMY);
		testSetup.add(FILTER_DELAY + 131992, new FmsData(FW, BW, "64", "07-99", NUR_VOM_FZG, LST_ZU_FZG, TKI_III,
				"Unwetter Wassernot  \n\nIm Untertal 21      \nYach"));
