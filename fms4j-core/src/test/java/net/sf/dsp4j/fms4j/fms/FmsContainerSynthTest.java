...
import static net.sf.dsp4j.fms4j.fms.FMS_16bit_Mono_11025_Test.FILTER_DELAY;
...
public class FmsContainerSynthTest extends VisualResultCheckTest {
    ...
    final private static Logger LOG = LoggerFactory.getLogger(FmsContainerSynthTest.class);
